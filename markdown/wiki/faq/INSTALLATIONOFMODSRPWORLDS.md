# How to install mods, Resource packs and worlds into Copper Launcher
...
3. In the Copper Launcher menu, you will see "game directory" button, click it.
...
```
 ...
 ## Resource packs 
1. In the Copper Launcher menu, you will see "game directory" button, click it.
