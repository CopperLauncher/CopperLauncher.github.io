...
## Android 10 and newer
  ...
  **/storage/emulated/0/Android/data/org.copperlauncher.amethyst/files/latestlog.txt**

1. Install [Files by Marc apps & software](https://play.google.com/store/apps/details?id=com.marc.files) from Play Store.
2. Press the 3 lines in the top left corner → Copper Launcher → latestlog.txt

If Copper Launcher does not appear in the 3 lines menu, try closing (or opening) Copper Launcher. If that doesn't work, try restarting your phone.
...
## Android 9 and older <!-- TODO: update path to the log on andod 9 and older -->
  ...
  **/storage/emulated/0/games/Copper Launcher/latestlog.txt**
