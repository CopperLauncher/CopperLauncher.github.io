...
## Holy GL4ES
- Optimized for performance, Holy GL4ES is the default renderer in Copper Launcher and should be used in almost all scenrarios. 
...
![angle](https://raw.githubusercontent.com/whal-whales/random-imgs-repo-for-stuff/refs/heads/main/Screenshot_20240922_124430_Copper Launcher%20(Minecraft%20Java%20Edition%20for%20Android).jpg)
...
> On the current version of Copper Launcher, Mali with Vulkan 1.1 or some Vulkan 1.3 driver (need more testers with Mali Vulkan 1.3 devices). cannot run Minecraft 1.16.5 and below with Zink due to Mali driver issue with Mesa 23.2.0-devel (MESA_GL_VERSION_OVERRIDE=<api version> (See https://wiki.copperlauncher.dev/wiki/faq/android/ZINKNOTWORKING.html). will not fix this issue)
