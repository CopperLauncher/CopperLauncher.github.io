...
Next, download Copper Launcher from [GitHub Actions](https://github.com/Copper LauncherTeam/Copper Launcher/actions). Open LADB, accept the ADB connection, then type (or copy paste) `pm install path/to/pojavlauncher/apk.apk`. If that also doesn't work, please make an issue on the [wiki github](https://github.com/Copper LauncherTeam/pojavlauncherteam.github.io), making sure to mention VenomousSteam81.
